...
const Navbar: React.FC = () => {
  ...
  return (
    <header className='fixed top-6 w-full bg-transparent z-50 mt-2 flex flex-col items-center'>
      <div className='flex items-center bg-blue-950 rounded w-5/6 max-w-4xl px-8'>
        {/* Logo */}
