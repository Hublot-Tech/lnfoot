              ...
              <div className="p-5">
                <div className="space-y-4">
                  <p className="text-sm text-muted-foreground">
                    Vous souhaitez conserver une copie ? Téléchargez notre politique de confidentialité.
                  </p>
        ...
        <div className="md:col-span-7 md:col-start-5 lg:col-start-6">
          <article className="prose prose-sm">
            ...
            <ul>
              ...
              <li>Informations de connexion (cookies, identifiants de session)</li>
            </ul>
            ...
            <ul>
              ...
              <li>Vous envoyer des newsletters et des informations sur nos contenus et services</li>
            ...
            <ul>
              ...
              <li>Nos prestataires de services pour le traitement des données</li>
              <li>Les autorités compétentes en cas de demande légale</li>
            </ul>
            <h2>Sécurité des Données</h2>
            <p>Nous prenons des mesures pour protéger vos données, notamment :</p>
            <ul>
              <li>Chiffrement des données</li>
              <li>Utilisation de protocoles de sécurité pour les transactions en ligne</li>
            ...
            <h2>Contact</h2>
            <p>
              Si vous avez des questions ou des préoccupations concernant notre politique de confidentialité, veuillez nous contacter à <a href="mailto:luvnationagency2@gmail.com">luvnationagency2@gmail.com</a>.
            </p>
            ...
            <ul>
              <li>Informations de paiement (mode de paiement, détails partiels de la carte)</li>
